    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      >
        <div className="h-full flex flex-col">
          {/* Logo */}
          <div className="h-16 flex items-center px-6 border-b border-white border-opacity-10">
                ...
                <Link
                  ...
                  className={`flex items-center gap-3 px-3 py-3 rounded-lg transition-colors ${
                    isActive
                      ...
                      : 'text-white hover:bg-white bg-opacity-5 hover:text-white'
                  }`}
                >
            ...
            {isSidebarOpen ? (
              <div className="space-y-3">
                ...
                <button
                  ...
                  className="flex items-center gap-2 w-full px-3 py-2 text-sm text-white hover:text-white hover:bg-white bg-opacity-5 rounded-lg transition-colors"
                >
              ...
              <button
                onClick={handleLogout}
                className="flex items-center justify-center w-10 h-10 mx-auto text-white hover:text-white hover:bg-white bg-opacity-5 rounded-lg transition-colors"
              >
